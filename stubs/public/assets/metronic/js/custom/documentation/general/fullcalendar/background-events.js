...
/*!**************************************************************************************!*\
  !*** ../demo1/src/js/custom/documentation/general/fullcalendar/background-events.js ***!
  \**************************************************************************************/
...
var KTGeneralFullCalendarEventsDemos = function() {
	...
	var exampleBackgroundEvents = function() {
		// Define colors
		var green = KTUtil.getCssVariableValue('--kt-active-success');
		var red = KTUtil.getCssVariableValue('--kt-active-danger');
