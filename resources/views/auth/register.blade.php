    ...
    <div class="card-body p-10 p-lg-20">
        ...
        <form method="POST" action="{{ route('register') }}" class="form w-100" novalidate="novalidate" id="kt_sign_up_form">
            ...
            <div class="text-center mb-11">
                <h1 class="text-dark fw-bolder mb-3">Criar uma conta</h1>
                <div class="text-gray-500 fw-semibold fs-6">Crie uma conta para acessar o sistema</div>
            </div>
            ...
            <div class="fv-row mb-8">
                ...
                <input type="email" placeholder="E-mail" name="email" value="{{ old('email') }}" autocomplete="off" class="form-control" />
                @error('email')
                <div class="fv-plugins-message-container invalid-feedback">
                    <div>{{ $message }}</div>
                </div>
